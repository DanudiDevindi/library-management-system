...
public class ViewBookController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        viewBookTable.getColumns().get(4).setCellValueFactory(new PropertyValueFactory<>("maciningNo"));
        ...
        viewBookTable.getColumns().get(8).setCellValueFactory(new PropertyValueFactory<>("PublisherDate"));
        ...
        viewBookTable.getColumns().get(11).setCellValueFactory(new PropertyValueFactory<>("removedate"));
        viewBookTable.getColumns().get(12).setCellValueFactory(new PropertyValueFactory<>("Supplier"));
        viewBookTable.getColumns().get(13).setCellValueFactory(new PropertyValueFactory<>("position_PosId"));
